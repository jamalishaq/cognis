...
class Settings(BaseSettings):
    ...
    reasoning_model_id: str = "amazon.nova-micro-v1:0"
    chat_model_id: str = "amazon.nova-micro-v1:0"
    triage_model_id: str = "amazon.nova-micro-v1:0"
    judge_model_id: str = "amazon.nova-micro-v1:0"
