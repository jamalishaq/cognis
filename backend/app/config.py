...
class Settings(BaseSettings):
    ...
    reasoning_model_id: str = "us.anthropic.claude-sonnet-4-6-20251101-v1:0"
    chat_model_id: str = "us.anthropic.claude-sonnet-4-6-20251101-v1:0"
    triage_model_id: str = "us.anthropic.claude-haiku-4-5-20251001-v1:0"
